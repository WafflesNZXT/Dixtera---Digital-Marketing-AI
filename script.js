...
const SERVICE_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      "Website copy & landing page copy",
      "Ad copywriting & marketing collateral",
      "Newsletter content",
      "Graphic design (social media graphics, infographics, banners)",
      "Video scripting & storyboarding",
      "Video filming & editing (tutorials, promos, reels)",
      "Content strategy & planning (editorial calendar)",
      "SEO-focused writing & keyword optimization",
    ],
  },
  {
    ...
    items: [
      ...
      "Platform-specific strategies (Instagram, LinkedIn, TikTok, etc.)",
      "Social account setup & optimization",
      "Social media branding & profile design",
      "Content creation for each platform (posts, stories, reels, videos)",
      "Post scheduling & publishing",
      "Paid advertising campaigns (Facebook Ads, Instagram Ads, LinkedIn Ads, etc.)",
      "Organic growth campaigns",
      "Community management (comment replies, messages, engagement)",
  ...
  },
  {
    ...
    items: [
      "Email campaign strategy (newsletter, drip campaigns, promos)",
      "Email copywriting (subject lines, body, calls-to-action)",
      "Email template design",
      "Audience segmentation & targeting",
      "A/B testing for subject lines, content, and design",
